...
This project is developed for academic purposes as part of an Agentic AI capstone.  
Responses are generated by an AI system and should be used for learning only, not as a substitute for textbooks or instructor guidance.
